  ...
  switch (props.iconName) {
    case "templates":
      return props.isActive ? (
        <Image alt="tempIcon" src={tempIcon} />
      ) : (
        <div className="flex h-[41px] w-[48px] items-center justify-center md:relative md:left-[16px] md:top-[5px] md:h-[39px] md:w-[46px]">
          <svg
            width="22"
            height="23"
            viewBox="0 0 22 23"
            ...
            className="md:h-[21.5px] md:w-[22px]"
          >
            <path
    ...
    case "chat":
      return props.isActive ? (
        ...
        fill="none" 
        xmlns="http://www.w3.org/2000/svg" 
        className="md:relative md:left-[30px] md:top-[5px] md:h-[39px] md:w-[44px]">
        ...
        <div className="flex h-[41px] w-[46px] items-center justify-center md:relative md:left-[30px] md:top-[5px] md:h-[39px] md:w-[44px]">
          <svg
            width="20"
            height="21"
            viewBox="0 0 20 21"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="md:h-[18.5px] md:w-[18px]"
          >
            <path
    ...
    case "learning":
      return props.isActive ? (
        <Image alt="learningIcon" src={learningIcon} />
      ) : (
        <div className="flex h-[41px] w-[48px] items-center justify-center md:relative md:left-[45px] md:top-[5px] md:h-[39px] md:w-[44px]">
          <svg
            width="22"
            height="23"
            viewBox="0 0 22 23"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="md:h-[19.5px] md:w-[19px]"
          >
            <path
    ...
    case "history":
      return props.isActive ? (
        ...
        // alt="hystoryIcon" 
        // src={hystoryIcon} 
        // className=" md:relative md:left-[63px] md:top-[5px] md:h-[39px]"/>
        <svg width="50" height="43" viewBox="0 0 48 41" fill="none" xmlns="http://www.w3.org/2000/svg" className=" md:relative md:left-[63px] md:top-[5px] md:h-[39px]">

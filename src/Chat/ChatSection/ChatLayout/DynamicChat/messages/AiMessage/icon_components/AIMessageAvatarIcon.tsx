...
export const AIMessageAvatarIcon = memo(function AIMessageAvatarIcon(){
    return (
        <div className="mr-[12px] flex h-[30px] w-[30px] items-start">
            <svg 
                width="30"
                height="30"
                viewBox="0 0 65 65" 
                ...
                className="rounded-[16px] gradientButton relative md:rounded-[10px] md:vsm:rounded-[8px] lg:top-[2px] lg:rounded-[10px] xl:top-[3px]">

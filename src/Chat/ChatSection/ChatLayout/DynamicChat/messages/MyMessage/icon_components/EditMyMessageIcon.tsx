...
export const EditMyMessageIcon = memo(function EditMyMessageIcon(){

    const {theme} = useTheme()

    return (
        <div className="relative ml-[4px] flex size-[32px] cursor-pointer items-end justify-center p-[6px] md:top-[-4px] md:vsm:top-[-2px] lg:top-[-2px] xl:top-[1px]">
          <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke={theme === 'light' ? '#0B3BEC' : '#667085'}
              strokeWidth="1.5"
              strokeLinecap="round"
